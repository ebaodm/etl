...
my ($conncfgf,$stepgroup,$truncatetablist)=("/ccicall/dc/script/config/conn.cfg","SYNSTEPAH",undef);
...
foreach my $steps (@{$tasksteps->{"result"}}){
	...
	my $dbresref=&getdbresref($conncfg{"dbname"},
		...
		#and etl_id NOT in ('433310','460449','460448','433309','429244','416705','416706','416704','416707','429245')");
